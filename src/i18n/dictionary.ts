...
const en = {
  ...
  register: {
    ...
    previewMapNote: "On the world map your pin stays soft (~100 km). Your public name stays Anonymous if you chose anonymity.",
    email: "Email (private only)",
    place: "Town / region",
    placePlaceholder: "City and country",
    photo: "Photo at home (optional)",
    mapConsent:
      "Optional: Show me on the world map with a soft pin (~100 km accuracy). The exact address stays private. If I stay anonymous, only “Anonymous” is shown — never my real name.",
    submitting: "Saving…",
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Optional registration of a Tiny Art Surprise may include registration number, first name, email address, place/region (for approximate location), map consent, an optional “stay anonymous publicly” choice, and an optional home photo. Your email and exact place remain private and are used only for administration, support, and — if you opt in — to calculate a blurred map pin. If you choose to stay anonymous publicly, your real first name is not shown on the public Collection page or on the world map; the public label is “Anonymous collector” / “Anonymous”. If you do not choose anonymity, only your first name may appear next to your artwork. Exact address, email, and other contact details are never public.",
      },
      {
...
const de = {
  ...
  register: {
    ...
    collectorPrefix: "Collector:",
    previewMapNote: "Auf der Weltkarte bleibt dein Pin unscharf (ca. 100 km). Bei Anonymität erscheint öffentlich nur Anonymous.",
    email: "E-Mail (nur intern)",
    place: "Ort / Region",
    placePlaceholder: "Stadt und Land",
    photo: "Foto zu Hause (optional)",
    mapConsent:
      "Optional: Zeig mich auf der Weltkarte mit einem weichen Pin (ca. 100 km genau). Die genaue Adresse bleibt privat. Wenn ich anonym bleibe, erscheint nur «Anonymous» — nie mein echter Name.",
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Bei der optionalen Registrierung einer Tiny Art Surprise können Registrierungsnummer, Vorname, E-Mail-Adresse, Ort/Region (für die ungefähre Lage), Einwilligung zur Weltkarte, die Option «öffentlich anonym bleiben» sowie optional ein Foto zu Hause erfasst werden. E-Mail und genauer Ort bleiben privat und dienen Verwaltung, Support und — bei Einwilligung — der Berechnung eines unscharfen Karten-Pins. Wählst du öffentliche Anonymität, erscheint dein echter Vorname weder auf der öffentlichen Collection-Seite noch auf der Weltkarte; öffentlich steht «Anonymous collector» / «Anonymous». Ohne Anonymität darf neben dem Kunstwerk nur der Vorname erscheinen. Exakte Adresse, E-Mail und weitere Kontaktdaten sind nie öffentlich.",
      },
      {
