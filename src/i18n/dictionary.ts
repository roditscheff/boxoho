...
const en = {
  ...
  postcard: {
    ...
    subscription: {
      ...
      mapConsent:
        "Optional: I agree that a blurred location (~100 km radius) of my shipping address, and my first name, may appear on the public collectors’ map. The exact address stays private.",
      ...
      manageCta: "Already subscribed?",
      portalEmail: "Email",
      portalEmailPlaceholder: "the email you used at checkout",
      manageSubmit: "Open customer portal",
      loading: "Redirecting…",
      shippingNote:
        "Details and payment in Stripe Checkout. Postcards: standard mail, not tracked. Newsletter: email only.",
...
const de = {
  ...
  postcard: {
    ...
    subscription: {
      ...
      mapConsent:
        "Optional: Ich bin einverstanden, dass ein unscharfer Standort (Umkreis ca. 100 km) meiner Versandadresse sowie mein Vorname auf der öffentlichen Collectors-Karte erscheinen dürfen. Die genaue Adresse bleibt privat.",
      ...
      manageCta: "Schon abonniert?",
      portalEmail: "E-Mail",
      portalEmailPlaceholder: "die E-Mail vom Checkout",
      manageSubmit: "Kundenportal öffnen",
      loading: "Weiterleitung…",
      shippingNote:
        "Angaben und Zahlung im Stripe-Checkout. Postkarten: normale Post, ohne Tracking. Newsletter: nur E-Mail.",
