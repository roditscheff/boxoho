...
const en = {
  ...
  postcard: {
    ...
    subscription: {
      ...
      planYearBody: "",
      planNewsletterOption: "Newsletter — CHF 5.00 / month",
      planMonthOption: "Postcard monthly — CHF 9.00 / month",
...
const de = {
  ...
  postcard: {
    ...
    subscription: {
      ...
      planYearBody: "",
      planNewsletterOption: "Newsletter — CHF 5.00 / Monat",
      planMonthOption: "Postkarte monatlich — CHF 9.00 / Monat",
